...
CREATE TABLE public.profiles (
  ...
  -- For individual users - scout settings
...
-- =====================================================
-- Company Profiles (for company accounts)
-- =====================================================
...
CREATE TABLE public.resumes (
  ...
  -- Format: [{ school_name, faculty, degree, start_date, end_date, is_current }]
...
CREATE TABLE public.work_histories (
  ...
  company_name TEXT NOT NULL,
  company_name_hidden TEXT, -- Used when user wants to hide company name
  industry TEXT,
  employee_count TEXT,
...
CREATE TABLE public.skills (
  ...
  skill_type TEXT NOT NULL, -- 'hard' or 'soft'
...
CREATE TABLE public.ai_generations (
  ...
  generation_type TEXT NOT NULL, -- 'summary', 'self_pr', 'career_objective', 'work_description', 'chat'
...
CREATE TABLE public.chat_sessions (
  ...
  title TEXT,
  session_type TEXT DEFAULT 'resume_edit', -- 'resume_edit', 'career_advice', 'interview_prep'
...
-- =====================================================
-- Offer Messages (Thread after initial offer)
-- =====================================================
...
CREATE TABLE public.notifications (
  ...
  -- Related entity
  related_entity_type TEXT, -- 'offer', 'message', 'resume'
...
CREATE TABLE public.billing_events (
  ...
  -- Related offer (for scout success)
  ...
  -- External payment reference (for Stripe etc.)
...
CREATE TABLE public.profile_imports (
  ...
  source_type TEXT NOT NULL, -- 'linkedin', 'wantedly', 'facebook'
...
CREATE TABLE public.photo_jobs (
  ...
  -- Format: { remove_background, background_color, crop_to_id, apply_beauty, add_suit }
